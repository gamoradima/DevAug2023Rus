namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyFreedomUIEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("01e3e243-a7ef-4bf9-9d02-d17992504a78");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("d8f06d10-c137-e64c-f172-ca02ec0255d1"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("a33e38b6-fe7d-4f83-a259-76df4eb607cf"),
				CreatedInSchemaUId = new Guid("01e3e243-a7ef-4bf9-9d02-d17992504a78"),
				ModifiedInSchemaUId = new Guid("01e3e243-a7ef-4bf9-9d02-d17992504a78")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("01e3e243-a7ef-4bf9-9d02-d17992504a78"));
		}
